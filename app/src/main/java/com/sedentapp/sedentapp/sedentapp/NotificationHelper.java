...
public class NotificationHelper {
    ...
    public void createNotification(String title, String message, Context context)
    {
        ...
        boolean notificacionPrefActivas = sharedPref.getBoolean("notifications_new_message", true);
        if(notificacionPrefActivas){
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O)
            {
                ...
                boolean notificacionPrefvibrate = sharedPref.getBoolean("notifications_new_message_vibrate", true);
                if(notificacionPrefvibrate){
